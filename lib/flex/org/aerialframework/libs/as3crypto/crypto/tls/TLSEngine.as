...
{
    import org.aerialframework.libs.as3crypto.crypto.cert.X509Certificate;
    import org.aerialframework.libs.as3crypto.crypto.cert.X509CertificateCollection;
    import org.aerialframework.libs.as3crypto.crypto.prng.Random;
    ...
    [Event(name="ready", type="org.aerialframework.libs.as3crypto.crypto.tls.TLSEvent")]
    [Event(name="data", type="org.aerialframework.libs.as3crypto.crypto.tls.TLSEvent")]
