 ...
 */
package org.aerialframework.libs.as3crypto.crypto.cert
{
    ...
    import org.aerialframework.libs.as3crypto.util.ArrayUtil;
    import org.aerialframework.libs.as3crypto.util.Base64;
    import org.aerialframework.libs.as3crypto.util.der.ByteString;
    import org.aerialframework.libs.as3crypto.util.der.DER;
    import org.aerialframework.libs.as3crypto.util.der.OID;
    ...
    import org.aerialframework.libs.as3crypto.util.der.Sequence;
    import org.aerialframework.libs.as3crypto.util.der.Type;
    import org.aerialframework.libs.as3crypto.util.der.Type2;
    ...
    public class X509Certificate
    {
        ...
        public function getPublicKey():RSAKey
        {
            ...
            pk.position = 0;
            var rsaKey:Object = DER.parse(pk, [
                {name:"N"},
                {name:"E"}
            ]);
