package org.aerialframework.libs.as3crypto.util.asn1.type
{
    ...
    {
        registerClassAlias("org.aerialframework.libs.as3crypto.util.asn1.ASN1Type", ASN1Type);
...
//			core = true;
        ...
        protected function readDERTag(s:ByteArray, classValue:int = UNIVERSAL, constructed:Boolean = false, any:Boolean = false):int
        {
